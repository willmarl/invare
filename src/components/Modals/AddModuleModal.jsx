...
function AddModuleModal() {
  ...
  const handleSubmit = (e) => {
    ...
    // No longer require quantity >= 1
    // Batch add: for each selected module, make a post request
        ...
        <div className="add-module-modal__table-wrapper">
          {nothingToAdd ? (
            <div className="add-module-modal__empty-message">
              {modules.length === 0
                ? "You have no modules to add. Create a module first."
                : "All your modules are already in your inventory."}
            </div>
          ) : (
